...
template <class Class, class ClassPrivate> class Pimpl
{
public:
    explicit Pimpl();
...
template <class Class, class ClassPrivate> Pimpl<Class, ClassPrivate>::~Pimpl()
{
    _unmake(d_ptr);
    d_ptr = 0;
}

template <class Class, class ClassPrivate> ClassPrivate *Pimpl<Class, ClassPrivate>::make()
{
    return new ClassPrivate;
}

template <class Class, class ClassPrivate> ClassPrivate *Pimpl<Class, ClassPrivate>::clone(ClassPrivate *p)
{
    return new ClassPrivate(*p);
}

template <class Class, class ClassPrivate> void Pimpl<Class, ClassPrivate>::unmake(ClassPrivate *p)
{
    delete p;
}

template <class Class, class ClassPrivate> ClassPrivate *Pimpl<Class, ClassPrivate>::_make() const
{
    return reinterpret_cast<Class const *>(this)->make();
}

template <class Class, class ClassPrivate> ClassPrivate *Pimpl<Class, ClassPrivate>::_clone(ClassPrivate *p) const
{
    return reinterpret_cast<Class const *>(this)->clone(p);
}

template <class Class, class ClassPrivate> void Pimpl<Class, ClassPrivate>::_unmake(ClassPrivate *p) const
{
    reinterpret_cast<Class const *>(this)->unmake(p);
}

template <class Class, class ClassPrivate> ClassPrivate *Pimpl<Class, ClassPrivate>::d_func()
{
    return reinterpret_cast<ClassPrivate *>(d_ptr);
}

template <class Class, class ClassPrivate> const ClassPrivate *Pimpl<Class, ClassPrivate>::d_func() const
{
