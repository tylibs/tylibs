...
tylibs_build_set_property(__COMPONENT_MANAGER_INTERFACE_VERSION 3)
...
function(__project_info test_components)
  ...
  tylibs_build_get_property(common_component_reqs __COMPONENT_REQUIRES_COMMON)
  ...
  __build_component_info("${build_components};${test_components}"
...
function(__project_init components_var test_components_var)
  ...
  if(COMPONENT_DIRS)
    ...
    tylibs_build_set_property(__COMPONENT_TARGETS "")
    foreach(component_dir ${COMPONENT_DIRS})
...
macro(project project_name)
  ...
  message(STATUS "Building ESP-TYLIBS components for target ${TYLIBS_TARGET}")
  ...
  if(tylibs::main IN_LIST build_components)
    __component_get_target(main_target tylibs::main)
    ...
    __component_get_property(managed_priv_reqs ${main_target}
  ...
  foreach(build_component ${build_components})
    ...
    __component_get_property(whole_archive ${build_component_target}
                             WHOLE_ARCHIVE)
    if(whole_archive)
      if(linker_type STREQUAL "GNU")
        message(
