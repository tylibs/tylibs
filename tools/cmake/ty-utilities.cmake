...
function(target_linker_script target deptype scriptfiles)
  ...
  foreach(scriptfile ${scriptfiles})
    ...
    # Note: In TYLIBS, most targets are libraries and libary LINK_DEPENDS don't
    # propagate to executable(s) the library is linked to. Since CMake 3.13,
    # INTERFACE_LINK_DEPENDS is available to solve this. However, when GNU Make
    # generator is used, this property also propagates INTERFACE_LINK_DEPENDS
    # dependencies to other static libraries. TODO: see if this is an expected
    # behavior and possibly report this as a bug to CMake. For the time being,
    # record all linker scripts in __LINK_DEPENDS and attach manually to the
    # executable target once it is known.
    if(NOT __PROCESS)
...
#
# Add prebuilt library with support for adding dependencies on TYLIBS
# components.
