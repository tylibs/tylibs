...
# add: tylibs_build_set_property(__BUILD_COMPONENT_DEPGRAPH_ENABLED 1) in the
...
function(depgraph_add_edge dep_from dep_to)
  ...
  tylibs_build_get_property(depgraph_enabled __BUILD_COMPONENT_DEPGRAPH_ENABLED)
  ...
  if(dep_to IN_LIST common_reqs)
    ...
    if(NOT dep_from IN_LIST common_reqs)
      tylibs_build_set_property(__BUILD_COMPONENT_DEPGRAPH
...
function(depgraph_generate out_path)
  ...
  tylibs_build_get_property(depgraph __BUILD_COMPONENT_DEPGRAPH)
